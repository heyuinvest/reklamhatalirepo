...
public class PlayerController2 : MonoBehaviour
{
    ...
    public static float sattackDens2;
    void Start()
    {

       if (PlayerPrefs.HasKey("shipAttackDens"))
        {
            sattackDens2 = PlayerPrefs.GetFloat("shipAttackDens");
        }
        else
            sattackDens2 = 0.5f;
    ...
    void Move()
    {
      ...
      IEnumerator BulletCoroutine() // bullet position
      {
        while(true)
        {
            ...
            yield return new WaitForSeconds(sattackDens2);
        }
